...
/*     */   }
/*     */   
/*     */   private SnapshotEntry(String id, String timestamp, String changeType, List<String> fields) {
/* 121 */     this.id = id; this.timestamp = timestamp; this.changeType = changeType; this.fields = fields; } public String id() { return this.id; } public String timestamp() { return this.timestamp; } public String changeType() { return this.changeType; } public List<String> fields() { return this.fields; }
/*     */ 
/*     */ }


/* Location:              C:\Users\amarf\AppData\Roaming\ModrinthApp\profiles\Cobblemon.gg - Ultimate Pokemon Experience\mods\atlas-common-fabric-1.2.0.jar!\com\atlas\common\fabric\lookup\screen\views\LookupSnapshotsView$SnapshotEntry.class
